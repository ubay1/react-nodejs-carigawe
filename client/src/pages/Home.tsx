...
const Home = () => {
        ...
        return(
            ...
            >
                ...
                >
                    ...
                    className={`
                        lg:list-reset lg:mb-0
                        flex ${userRedux.token !== '' ? 'flex-col' : 'flex-row'} items-center justify-center
                        mb-4
                    `}>
                    {
                        userRedux.token !== '' 
    ...
    const Recruiter = () => (
        <div className="-z-10 relative px-2 bg-gray-50">
            <div className=" 
                md:grid md:grid-cols-md-3rows-content
            ">
                {
                    postJobs.map((item: any, index: number) => {
                        return(
                                <div 
                                    key={`indexPost-${index}`}
                                    className="px-5 py-4 mx-2 my-4 bg-white dark:bg-gray-800 shadow rounded-lg"
                                >
